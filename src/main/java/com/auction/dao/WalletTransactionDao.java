...
/**
 * DAO ghi sổ cái ví người dùng trong các luồng nghiệp vụ bình thường — append-only (chỉ thêm, không
 * sửa/xóa).
 *
 ...
 * đủ: bất kỳ tranh chấp nào về số dư đều có thể được tái hiện bằng cách replay toàn bộ lịch sử giao
 * dịch.
 *
