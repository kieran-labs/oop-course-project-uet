 ...
 *
 * <ul>
 *   <li>A {@code BIDDER} accessing endpoints reserved for {@code SELLER} or {@code ADMIN}
 *   <li>A seller attempting to modify an auction owned by another seller
 *   <li>An unauthenticated user accessing protected resources
 *   <li>Token validation failure (expired, invalid signature)
 * </ul>
 *
 * <p>Typical usage:
 *
